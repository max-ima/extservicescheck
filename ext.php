...
namespace david63\extservicescheck;
	...
	*/
	public function is_enableable()
	{
		...
		if (!$is_enableable)
		{
			...
			{
				$this->container->get('language')->add_lang('ext_enable_error', 'david63/extservicescheck');
			}
			else
			{
				$this->container->get('user')->add_lang_ext('david63/extservicescheck', 'ext_enable_error');
			}
		}
